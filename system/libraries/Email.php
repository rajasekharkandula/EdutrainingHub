...
class CI_Email {
	...
	var	$smtp_host		= "mail.mysmaty.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "webmaster@mysmaty.com";		// SMTP Username
	var	$smtp_pass		= "Pass@word1!";		// SMTP Password
