		...
		<div class="container">
			<div class="row mt-20">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="page-title pull-left"><button class="prev-btn hide"><i class="fa fa-arrow-left" aria-hidden="true"></i></button>States</div>
					<a href="<?php echo base_url('admin/state');?>" class="btn pull-right"><i class="fa fa-plus"></i> Add</a>
				</div>
			</div>
			<hr class="mt-0"></hr>
			<div class="panel">
					...
					<table class="table table-striped table-bordered" id="datatable">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo $s->countryName; ?></td>
								<td><a href="<?php echo base_url('admin/state/'.$s->stateID);?>" class="btn btn-small"> <i class="fa fa-pencil"></i> Edit </a></td>
							</tr>
							<?php } ?>
						</tbody>
					</table>				
