		...
		<div class="container">
			<div class="row mt-20">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="page-title pull-left">Testimonials</div>
					<a href="<?php echo base_url('admin/testimonial_create');?>" class="btn pull-right"><i class="fa fa-plus"></i> Add </a>
				</div>
			</div>
			<hr class="mt-0"></hr>
			<div class="panel">
				<div class="panel-body">
					<table class="table table-striped table-bordered" id="datatable">
						...
						<tbody>
							...
							<tr>
								<td><img src="<?php echo base_url($g->image); ?>"></td>
								<td><?php echo $g->name; ?></td>
								<td><?php echo $g->designation; ?></td>
								<td><?php echo $g->review; ?></td>
								<td><a href="<?php echo base_url('admin/testimonial_create/'.$g->testimonialID);?>" class="btn btn-small"> <i class="fa fa-pencil"></i> Edit </a></td>
							</tr>
							<?php } ?>
						</tbody>
					</table>				
